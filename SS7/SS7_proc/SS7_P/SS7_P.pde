...
fill(255, 255, 255);circle(100,120,3);
 ...
 fill(255);noStroke();ellipse(cloudX,160, val+60,20);
  cloudX++;
  if (cloudX > width) {
    cloudX = 0;
  }

fill(255);ellipse(cloudX2,170,val+50,20);
 cloudX2++;
  if (cloudX2 > width) {
    cloudX2 = 0;
...
fill(255);ellipse(cloudX3,270,val+100,40);
 cloudX3++;
  if (cloudX3 > width) {
    cloudX3 = 0;
}

fill(255);ellipse(cloudX4,670,val+100,40);
 cloudX4++;
  if (cloudX4 > width) {
    cloudX4 = 0;
  }
  
fill(255);ellipse(cloudX5,700,val+60,10);
 cloudX5++;
  if (cloudX5 > width) {
    cloudX5 = 0;
  }
fill(255);ellipse(cloudX6,660,val+100,20);
 cloudX6++;
  if (cloudX6 > width) {
    cloudX6 = 0;
  }
fill(255);ellipse(cloudX7,160,val+80,30);
 cloudX7++;
  if (cloudX7 > width) {
    cloudX7 = 0; 
  }
  
 fill(255);ellipse(cloudX8,400,val+300,100); 
   cloudX8++;
  if (cloudX8 > width) {
    cloudX8 = 0;
